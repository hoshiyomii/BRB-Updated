...
<head>
    <meta charset="utf-8">
    <title>Blue Ridge B- About</title>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <h1 class="text-white mb-4">Feature</h1>
                        <p class="text-white mb-4 pb-2">Barangay Blue Ridge B is committed to providing excellent community services through dedicated barangay employees, ensuring quality assistance, positive engagement, and 24-hour support for residents, creating a safe and thriving neighborhood for al</p>
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <h5 class="text-white mb-0">Barangay Employees</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Barangay Officials</p>
                <h1>Our Barangay Officials</h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        ...
                        <div class="team-text bg-light text-center p-4">
                            <h5> Name</h5>
                            <p class="text-primary">Barangay Vice-Captain</p>
                            <div class="team-social text-center">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        ...
                        <div class="team-text bg-light text-center p-4">
                            <h5> Name</h5>
                            <p class="text-primary">Barangay Management Head</p>
                            <div class="team-social text-center">
                            </div>
                        </div>
                    </div>
