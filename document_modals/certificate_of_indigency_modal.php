...
<div class="modal-header bg-primary text-white">
    <h5 class="modal-title">Certificate of Indigency Details</h5>
...
<div class="modal-body">
    ...
    <p><i class="fas fa-home"></i> <strong>Occupation:</strong> <?php echo htmlspecialchars($request['occupancy']); ?></p>
    <p><i class="fas fa-money-bill-wave"></i> <strong>Purpose:</strong> <?php echo htmlspecialchars($request['purpose']); ?></p>
